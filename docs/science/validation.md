...
نقشهٔ عمومی محصول‌های دارای `is_fixture=true` را نمایش نمی‌دهد. تا زمانی که یک محصول واقعی
پس از نرمال‌سازی، کنترل NoData، تطبیق ماسک و ثبت نسخه منتشر نشده باشد، رابط فقط شناسنامهٔ
منبع واقعی را نشان می‌دهد؛ fixtureها به آزمون نرم‌افزار محدود می‌مانند.
