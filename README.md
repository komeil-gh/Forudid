...
نسخهٔ `0.2.0-alpha.11` دادهٔ واقعی Haghighi–Motagh (۲۰۱۴–۲۰۲۰) را نمایش می‌دهد:
...
نسخه‌دار جمعیت و زیرساخت تولید و دانلود شده‌اند؛ CLI یکپارچه و پذیرش نهایی V2 باقی است؛
