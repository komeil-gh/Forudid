...
[تصمیم‌های معماری V2](docs/v2/adr/) مبنای این گذارند. قابلیت‌های V2 هنوز پیاده‌سازی
و پذیرفته نشده‌اند؛ V2 به تولید اختصاصی InSAR وابسته نخواهد بود و exposure را ریسک
