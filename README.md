...
نسخهٔ `0.2.0-rc.1` دادهٔ واقعی Haghighi–Motagh (۲۰۱۴–۲۰۲۰) را نمایش می‌دهد:
...
ورود داده، تحلیل و گزارش را با همان موتورهای موجود اجرا می‌کند. پذیرش نهایی V2 در جریان است؛
