...
نسخهٔ `0.2.0-alpha.5` دادهٔ واقعی Haghighi–Motagh (۲۰۱۴–۲۰۲۰) را نمایش می‌دهد:
...
راه‌آهن با دادهٔ واقعی منتشر شده است؛ [روش و شواهد](docs/v2/line-exposure.md).
...
[مرزهای تاریخی](docs/v2/regions.md) را ببینید. تکمیل تحلیل جاده‌ها، مواجههٔ منطقه‌ای
زیرساخت، فهرست/رتبه‌بندی دارایی‌ها، گزارش و روش‌های تفاضلی V2 باقی است.
