...
نسخهٔ `0.2.0-alpha.6` دادهٔ واقعی Haghighi–Motagh (۲۰۱۴–۲۰۲۰) را نمایش می‌دهد:
...
[مرزهای تاریخی](docs/v2/regions.md) را ببینید. مواجههٔ منطقه‌ای
زیرساخت، حالت‌های اصلی نقشه، گزارش و روش‌های تفاضلی V2 باقی است.
